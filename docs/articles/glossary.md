...
- **Variable**: The complete, compound term that describes what you
  ...
  `term_iri`.
- **Property**: The measurable characteristic (e.g., “abundance”,
  “temperature”, “length”). Maps to `property_iri`. For fish totals,
  abundance is the characteristic while a counting unit such as QUDT
  `Individual` records how the value is expressed.
