...
### The 2026-09-25 S16 convergence findings

Found while four metasalmonpy convergence items were built for S16 step 1 (B-360, B-362, B-363, B-364; metasalmonpy #53 to #56). Each was re-checked before it was filed, under R 4.5.2 run standalone against the exact pattern or file, or by reading both packages' code. The conditions are in the item files, which win where the two differ.
