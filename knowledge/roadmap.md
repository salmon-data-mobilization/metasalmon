...
- [S9 — Ontology conventions and alignment pass](sequences/s9-ontology-alignment.md) · step 7's four decisions are made; gcdfo #67 is closed, #68–#75 stay open behind successors #84/#85 and smn PR #27. **2026-09-02 source pass** (52-citation ledger, four commons cards): Ogden 2015 §2.3 located — #85 half-unblocked, but the SPSR integers run the opposite way to the report (new decision 9); "management level" has no published DFO counterpart (#84 precedent favours reading (a)); PR #27 needs the annotation amendments in `smn_pr27_definition_amendments.ttl` before the eight rulings — two attributions fail the passage check
