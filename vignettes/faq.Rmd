...
constraint, and method candidates together. Only variable, property, entity,
and unit acceptances can become `REVIEW:` prefills. Constraint and method
decisions always require manual application, and deterministic validators can
downgrade unsupported model acceptances to `review`.
