...
- **Constraint**: Optional fixed qualifiers that narrow the scope (e.g., "maximum", "wild-origin only", "female", or "spawner stage"). Maps to `constraint_iri`; multiple constraint IRIs are separated with semicolons. Row-varying values belong in table dimensions rather than being repeated as fixed column constraints.
