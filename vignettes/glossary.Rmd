...
- **Property**: The measurable characteristic (e.g., "count", "temperature", "length"). Maps to `property_iri`.
- **Entity**: The thing being measured (e.g., "spawning salmon", "stream water"). Maps to `entity_iri`.
- **Constraint**: Optional qualifiers that narrow the scope (e.g., "maximum", "annual", "wild-origin only"). Maps to `constraint_iri`.
