...
- **entity_iri** and **property_iri**: required links for measurement columns. Use `property_iri` to specify what characteristic was measured (e.g., "count"), and `entity_iri` to specify what was measured (e.g., "spawning salmon").
- **constraint_iri**: an optional I-ADOPT component that qualifies the measurement (e.g., "maximum", "annual average"). Use it only when it adds clarity.
