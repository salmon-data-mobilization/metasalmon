...
- If you cannot find a fitting term, use a metadata-first proposed-terms workflow (for example a local `proposed_terms.csv`) or the new gap detection tools in metasalmon:
  ...
  - The dedicated [After Excel Review](post-review-package-publication.html) guide shows how to use those helpers on a reviewed package and translate the generic `profile` bucket into the practical DFO-specific routing decision.
